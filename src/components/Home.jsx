...
import FormsAvaliacoes from "./Avaliacoes/FormsAvaliacoes";
import Carrossel from "./CarrosselHome/Carrossel";
			...
			>
				...
				<div className="relative z-10 flex flex-col items-center justify-center text-white text-center p-4 h-[calc(100vh-80px)]">
					...
					<p className="text-lg md:text-2xl max-w-2xl drop-shadow-md">
						O melhor do litoral paulista espera por você: praias, eventos e
						cultura vibrante.
					</p>

					<a
						href="#eventos"
						className="bg-[#FFA303] hover:bg-[#e09203] transition-colors text-white font-bold py-3 px-8 rounded-full mt-12 shadow-lg flex items-center gap-2"
					>
						EXPLORE AS ATRAÇÕES
					</a>
			...
			<section id="eventos" className="">
				...
				<div className="container mx-auto px-4">
					...
					<div className="flex justify-center p-10">
						<Link
							to="/eventos"
							className="bg-[#00509d] hover:bg-[#003f7d] text-white font-bold py-3 px-10 rounded shadow-md flex items-center gap-2 transition-all"
						>
			...
			<section className="flex flex-col md:flex-row w-full min-h-[500px]">
				...
				<div className="w-full md:w-1/2 bg-[#00509d] p-12 flex flex-col justify-center items-start text-white">
					...
					<p className="text-lg leading-relaxed mb-8 text-justify opacity-90">
						Descubra as maravilhas de Praia Grande. Da grandiosidade da
						Fortaleza de Itaipu à beleza serena da orla, temos roteiros para
						todos os gostos.
					</p>
					<Link
						to="/atracoes"
						className="bg-white text-[#00509d] font-bold py-3 px-8 rounded hover:bg-gray-100 transition-colors flex items-center gap-2 self-end md:self-start"
					>
			...
			<section className="flex flex-col md:flex-row-reverse w-full min-h-[500px]">
				<div className="w-full md:w-1/2 bg-gray-900 relative">
					{imgAgendaCultural ? (
						...
						<div
							className="w-full h-full"
							style={{
								backgroundImage: `url(${imgCultura})`,
								backgroundSize: "cover",
								backgroundPosition: "center",
							}}
						></div>
				...
				<div className="w-full md:w-1/2 bg-[#003566] p-12 flex flex-col justify-center items-end text-right text-white">
					...
					<p className="text-lg leading-relaxed mb-8 opacity-90">
						O Palácio das Artes e os teatros da cidade oferecem uma programação
						rica e diversificada. Fique por dentro das exposições e peças de
						teatro.
					</p>
					<Link
						to="/agendaCultural"
						className="bg-white text-[#003566] font-bold py-3 px-8 rounded hover:bg-gray-100 transition-colors flex items-center gap-2"
					>
						SAIBA MAIS <ArrowRight className="text-[#FFA303]" />
					</Link>
				</div>
